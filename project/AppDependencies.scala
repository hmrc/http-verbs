...
object AppDependencies {
  ...
  def coreTestCommon(scalaVersion: String) = Seq(
  ...
  val testCompilePlay29 = Seq(
    "org.scalatest"          %% "scalatest"     % "3.2.15",       // version provided transitively is chosen for compatibility with scalatestplus-play
