...
object AppDependencies {
  ...
  val compilePlay26 = Seq(
    ...
    "com.typesafe.play" %% "play-ws"   % Play26.version
  )

  val compilePlay27 = Seq(
    "com.typesafe.play" %% "play-json" % Play27.version,
    "com.typesafe.play" %% "play-ws"   % Play27.version
  )
  ...
  val testPlay26 = Seq(
    ...
    "com.typesafe.play" %% "play-ahc-ws" % Play26.version % Test
  )

  val testPlay27 = Seq(
    "com.typesafe.play" %% "play-test"   % Play27.version % Test,
    "com.typesafe.play" %% "play-ahc-ws" % Play27.version % Test
  )
}
